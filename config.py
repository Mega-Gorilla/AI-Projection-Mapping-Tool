class config:
    server_address = "http://192.168.0.65:7860/"
    preset_prompt = "best quality, masterpiece, ultra-detailed, 8k, high resolution, very aesthetic, absurdres,"
    ...
    sam_mask_output_path = "./images/output/masks"
